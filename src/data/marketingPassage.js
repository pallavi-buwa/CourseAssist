export const passage = {
  ...
  sections: [
    {
      id: 's1',
      content: 'Market segmentation is the process of dividing a broad target market into subsets of consumers who have common needs, interests, and priorities. By identifying these segments, companies can design and implement strategies to target them more effectively. Segmentation can be based on demographics (age, income, education), psychographics (lifestyle, values), geographic regions, or behavioral patterns such as purchase history.',
      microCheck: {
